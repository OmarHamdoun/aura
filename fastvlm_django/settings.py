...
# Second YOLO model — OR/procedure room equipment (hospital_yolo, 13 classes, mAP50=0.972)
YOLO_MODEL_PATH_B = os.environ.get(
    "YOLO_MODEL_PATH_B",
    "/home/vision/work/aura/models/hospital_yolo/weights/best.pt",
)
YOLO_CONF_B = float(os.environ.get("YOLO_CONF_B", "0.40"))
...
HOSPITAL_EVAL_SAVE_DIR = BASE_DIR / "media" / "hospital_eval"
HOSPITAL_EVAL_SAVE_YOLO = _env_flag("HOSPITAL_EVAL_SAVE_YOLO", "1")
...
MLFLOW_EXPERIMENT_NAME  = os.environ.get("MLFLOW_EXPERIMENT_NAME", "gpas-hospital")
MLFLOW_RUN_NAME_PREFIX  = os.environ.get("MLFLOW_RUN_NAME_PREFIX", "gpas")
